...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr --disable-debug --disable-static --enable-shared --enable-avresample --enable-fontconfig --enable-gnutls --enable-gpl --enable-ladspa --enable-libaacplus --enable-libass --enable-libbluray --enable-libcaca --enable-libcdio --enable-libcelt --enable-libdc1394 --enable-libfaac --enable-libfdk-aac --enable-libfreetype --enable-libgme --enable-libgsm --enable-libiec61883 --enable-libmodplug --enable-libmp3lame --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libopenjpeg --enable-libopus --enable-libpulse --enable-librtmp --enable-libschroedinger --enable-libsoxr --enable-libspeex --enable-libssh --enable-libtheora --enable-libtwolame --enable-libv4l2 --enable-libvo-aacenc --enable-libvo-amrwbenc --enable-libvorbis --enable-libvpx --enable-libwavpack --enable-libx264 --enable-libxvid --enable-libzmq --enable-libzvbi --enable-nonfree --enable-openal --enable-openssl --enable-pic --enable-vda --enable-version3 --enable-x11grab --enable-opencl
prefix=/usr
...
CC_IDENT=gcc 4.8.2 (GCC) 20131219 (prerelease)
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-D_FORTIFY_SOURCE=2 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS=-march=x86-64 -mtune=native -O2 -pipe -fstack-protector --param=ssp-buffer-size=4   -std=c99 -fomit-frame-pointer -fPIC -pthread -I/usr/include/freetype2 -I/usr/include/p11-kit-1 -I/usr/include/harfbuzz -I/usr/include/freetype2 -I/usr/include/fribidi -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/freetype2  -I/usr/include/freetype2 -I/usr/include/opus -D_REENTRANT  -I/usr/include/schroedinger-1.0 -I/usr/include/orc-0.4    -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/include/SDL -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS=-march=x86-64 -mtune=native -O2 -pipe -fstack-protector --param=ssp-buffer-size=4  -D__STDC_CONSTANT_MACROS
ASFLAGS=   -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=-Wl,-O1,--sort-common,--as-needed,-z,relro  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-ldl -lXv -lX11 -lXext -lva -lXfixes -lXext -lX11 -lcdio_paranoia -lcdio_cdda -lcdio -ljack -lasound -lSDL -lpthread -ldc1394 -lraw1394 -lnettle -lhogweed -lgmp -lssl -lcrypto -lOpenCL -lopenal -lzvbi -lzmq -lxvidcore -lx264 -lwavpack -lvpx -lvpx -lvpx -lvpx -lvorbisenc -lvorbis -logg -lvo-amrwbenc -lvo-aacenc -lv4l2 -ltwolame -ltwolame -ltheoraenc -ltheoradec -logg -lspeex -lssh -lsoxr -lschroedinger-1.0 -lrtmp -lz -lssl -lcrypto -lpulse-simple -lpulse -lopus -lopenjpeg -lopencore-amrwb -lopencore-amrnb -lmp3lame -lmodplug -lgsm -lgme -lstdc++ -lfreetype -lfdk-aac -lfaac -lcaca -lcelt0 -lcelt0 -lbluray -lass -laacplus -lraw1394 -lavc1394 -lrom1394 -liec61883 -lgnutls -lfontconfig -lfreetype -lm -pthread -lbz2 -lz 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
